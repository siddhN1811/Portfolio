      ...
      <div className="about-me-container">
        ...
        <div className="about-me-text">
          ...
          Hello! I'm Siddhanth Naidu, a passionate and dedicated computer engineering
           ...
           conversion using UML, showcasing my technical prowess and analytical thinking. With Adobe Photoshop, Figma, ChatGPT, HTML5, CSS, Python, Unreal Engine, and a dash of creativity, 
